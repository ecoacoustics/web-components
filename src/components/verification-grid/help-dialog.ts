...
export class VerificationHelpDialogComponent extends AbstractComponent(LitElement) {
  ...
  private informationTemplate(): TemplateResult<1> {
    ...
    return html`
      <p>
        The Verification grid is a tool to help you validate and verify audio
        events either generated by a machine learning model or by a human
        annotator.
      </p>
      ...
      <p>
        Any recordings that you do not apply a decision to will be marked as
        "SKIP" when the results are downloaded.
      </p>
    `;
  }
